  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
          Pondok adalah penjara suci yang memisahkan antara yang batil dan yang hak, Indonesia sudah penuh dengan orang pintar namun kurang orang benar.
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-white">Santri</a>
        </p>
        <p class="mb-4">
